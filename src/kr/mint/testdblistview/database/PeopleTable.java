...
import kr.mint.testdblistview.PersonBean;
...
//   private static final String WHERE_BY_DATE = "strftime('%Y'," + DATE + ")=?";
   ...
   * @return
   */
//  public ArrayList<PersonBean> loadByName(boolean $isDesc)
//  {
...
//  }
   ...
   * @return
   */
  public ArrayList<PersonBean> loadByDate(boolean $isDesc)
  {
    ArrayList<PersonBean> result = new ArrayList<>();
   ...
   * @return
   */
//  public ArrayList<PersonBean> loadByDate(String $year)
//  {
//    ArrayList<PersonBean> result = new ArrayList<>();
//    
//    String[] selectionArgs = { $year };
//    Cursor c = db().query(TABLE, COLUMNS, WHERE_BY_DATE, selectionArgs, null, null, ORDER_BY_DEFAULT);
//    
//    Log.i("TestTable | loadByDate()", c.getCount() + "개");
//    
//    if (c.getCount() == 0)
...
//  }
  ...
  private PersonBean makeBean(Cursor cursor)
  {
    ...
    return new PersonBean(id, name, createdAt, updatedAt);
  }
